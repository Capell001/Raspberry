...
class App:
    def __init__(self,window):
        ...
        self.cred = credentials.Certificate(
            '/home/pi/Documents/iotcapel-firebase-adminsdk-ps4ca-ae3a93fb58.json')
        firebase_admin.initialize_app(self.cred, {
            'databaseURL': 'https://iotcapel.firebaseio.com/',
            'databaseAuthVariableOverride': {'uid': 'XRRA8T9973hygQDy5W4JhTMGJqh2'}
        })
        ...
        Button(buzzerFrame, text="Buzzer Control", padx=10, pady=10, command=self.userClickBuzzer).pack(expand=YES,
                                                                                                        fill=BOTH,
                                                                                                        padx=30,
                                                                                                        pady=10);
        ...
        Button(lcdFrame, text="send", command=self.userClickSend, padx=10, pady=10).grid(row=2, column=0, columnspan=2,
        ...
        Button(memberFrame, text="send", command=self.addMember, padx=10, pady=10).grid(row=2, column=0, columnspan=2,
                                                                                        sticky=NSEW, padx=5, pady=5);
        memberFrame.pack();
    ...
    def LEDState(self):
        ledControlRef = db.reference(path='iot0624/LED')

        try:
            ledState = ledControlRef.get()
